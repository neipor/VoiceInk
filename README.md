...
My goal is to make it **the most efficient and privacy-focused voice-to-text solution for macOS** that is a joy to use.

## neipor patch

This build removes the paid/Pro license requirement. VoiceInk is patched to run as a free app with all features available, no trial limits, purchase flow, or license activation required.
